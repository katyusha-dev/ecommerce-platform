 ...
 */
     ...
     */ 
        ...
        {
                        /** @var \Katyusha\Drivers\Payment\PaymentManager $instance */
         ...
         * @static 
         */ 
        public static function createStripeDriver($apiConsignment, $paymentRequestConsignment)
        {
                        /** @var \Katyusha\Drivers\Payment\PaymentManager $instance */
                        return $instance->createStripeDriver($apiConsignment, $paymentRequestConsignment);
        }
                    /**
         * 
         *
         * @static 
         */ 
        public static function createVippsDriver($apiConsignment, $paymentRequestConsignment)
        {
                        /** @var \Katyusha\Drivers\Payment\PaymentManager $instance */
                        return $instance->createVippsDriver($apiConsignment, $paymentRequestConsignment);
        }
                    /**
         * 
         *
         * @static 
         */ 
        public static function create($driver, ...$args)
        {            //Method inherited from \Katyusha\Framework\Support\Manager         
                        return \Katyusha\Drivers\Payment\PaymentManager::create($driver, ...$args);
        }
                    /**
         ...
         * @return \Katyusha\Drivers\Payment\PaymentManager 
         * @static 
         */ 
...
namespace  { 
            class Payment extends \Katyusha\Drivers\Payment\PaymentFacade {}
